...
func (x *LoginResponse) GetData() *LoginResponse_Response {
	if x, ok := x.GetResponse().(*LoginResponse_Data); ok {
		return x.Data
	}
	return nil
}
...
func (m *ValidateResponse) GetResponse() isValidateResponse_Response {
	if m != nil {
		return m.Response
	}
	return nil
...
func (x *ValidateResponse) GetData() *ValidateResponse_Response {
	if x, ok := x.GetResponse().(*ValidateResponse_Data); ok {
		return x.Data
	}
	return nil
}
...
func (x *ValidateResponse) GetError() string {
	if x, ok := x.GetResponse().(*ValidateResponse_Error); ok {
		return x.Error
	}
	return ""
}

type isValidateResponse_Response interface {
	isValidateResponse_Response()
}
...
func (*ValidateResponse_Data) isValidateResponse_Response() {}

func (*ValidateResponse_Error) isValidateResponse_Response() {}
...
func (x *RefreshResponse) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *RefreshResponse) GetData() *RefreshResponse_Response {
	if x, ok := x.GetResponse().(*RefreshResponse_Data); ok {
		return x.Data
	}
	return nil
}
...
func (x *RefreshResponse) GetError() string {
	if x, ok := x.GetResponse().(*RefreshResponse_Error); ok {
		return x.Error
	}
	return ""
}
...
func (*RefreshResponse_Data) isRefreshResponse_Response() {}

func (*RefreshResponse_Error) isRefreshResponse_Response() {}
...
type LoginResponse_Response struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *LoginResponse_Response) Reset() {
	*x = LoginResponse_Response{}
	if protoimpl.UnsafeEnabled {
...
func (x *LoginResponse_Response) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoginResponse_Response) ProtoMessage() {}

func (x *LoginResponse_Response) ProtoReflect() protoreflect.Message {
	mi := &file_auth_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoginResponse_Response.ProtoReflect.Descriptor instead.
func (*LoginResponse_Response) Descriptor() ([]byte, []int) {
	return file_auth_proto_rawDescGZIP(), []int{1, 0}
}

func (x *LoginResponse_Response) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *LoginResponse_Response) GetRefresh() string {
	if x != nil {
		return x.Refresh
	}
	return ""
...
type ValidateResponse_Response struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ValidateResponse_Response) Reset() {
	*x = ValidateResponse_Response{}
	if protoimpl.UnsafeEnabled {
...
func (x *ValidateResponse_Response) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ValidateResponse_Response) ProtoMessage() {}

func (x *ValidateResponse_Response) ProtoReflect() protoreflect.Message {
	mi := &file_auth_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ValidateResponse_Response.ProtoReflect.Descriptor instead.
func (*ValidateResponse_Response) Descriptor() ([]byte, []int) {
	return file_auth_proto_rawDescGZIP(), []int{5, 0}
}

func (x *ValidateResponse_Response) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
type RefreshResponse_Response struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RefreshResponse_Response) Reset() {
	*x = RefreshResponse_Response{}
	if protoimpl.UnsafeEnabled {
...
func (x *RefreshResponse_Response) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RefreshResponse_Response) ProtoMessage() {}

func (x *RefreshResponse_Response) ProtoReflect() protoreflect.Message {
	mi := &file_auth_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RefreshResponse_Response.ProtoReflect.Descriptor instead.
func (*RefreshResponse_Response) Descriptor() ([]byte, []int) {
	return file_auth_proto_rawDescGZIP(), []int{7, 0}
}

func (x *RefreshResponse_Response) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
var file_auth_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x22, 0x3c, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x16, 0x0a, 0x06, 0x70, 0x61, 0x73, 0x73,
	...
	0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e,
	...
	0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x1a, 0x3a, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x66, 0x72,
	0x65, 0x73, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x72, 0x65, 0x66, 0x72, 0x65,
	0x73, 0x68, 0x42, 0x0a, 0x0a, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x79,
	...
	0x08, 0x6c, 0x61, 0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x46, 0x0a, 0x10, 0x52, 0x65, 0x67,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xa5, 0x01, 0x0a, 0x10, 0x56,
	...
	,
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x34, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x52, 0x65, 0x66, 0x72,
	0x65, 0x73, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x52, 0x65, 0x73, 0x70,
	...
	,
	...
	0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xa2, 0x02, 0x0a, 0x0b, 0x41, 0x75,
	...
	0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x33, 0x0a, 0x06, 0x4c, 0x6f, 0x67,
	...
	0x4c, 0x6f, 0x67, 0x6f, 0x75, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x37,
	...
	0x68, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x2f, 0x61, 0x75, 0x74,
...
var file_auth_proto_goTypes = []interface{}{
	...
	(*LoginResponse_Response)(nil),    // 10: auth.LoginResponse.Response
	(*ValidateResponse_Response)(nil), // 11: auth.ValidateResponse.Response
	(*RefreshResponse_Response)(nil),  // 12: auth.RefreshResponse.Response
}
var file_auth_proto_depIdxs = []int32{
	10, // 0: auth.LoginResponse.data:type_name -> auth.LoginResponse.Response
	11, // 1: auth.ValidateResponse.data:type_name -> auth.ValidateResponse.Response
	12, // 2: auth.RefreshResponse.data:type_name -> auth.RefreshResponse.Response
	...
	7,  // 11: auth.AuthService.Refresh:output_type -> auth.RefreshResponse
...
func file_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_auth_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LoginResponse_Response); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_auth_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ValidateResponse_Response); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_auth_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RefreshResponse_Response); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_auth_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*ValidateResponse_Data)(nil),
		(*ValidateResponse_Error)(nil),
	}
	file_auth_proto_msgTypes[7].OneofWrappers = []interface{}{
		(*RefreshResponse_Data)(nil),
		(*RefreshResponse_Error)(nil),
	}
	type x struct{}
